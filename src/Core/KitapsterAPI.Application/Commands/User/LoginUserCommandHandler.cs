...
using KitapsterAPI.Infrastructure.Encryptor;
using MediatR;
...
namespace KitapsterAPI.Application.Commands.User
{
    public class LoginUserCommandHandler : IRequestHandler<LoginUserCommand, LoginUserViewModel>
    {
        ...
        {
            var dbUser = await userRepository.GetSingleAsync(i => i.EmailAddress == request.EmailAddres);
            ...
            if (!dbUser.EmailConfirmed)
                throw new Exception("Email Address is not confirmed yet! ");
